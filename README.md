...
Бот:
- проводит онбординг (`/start` -> запрос geolocation -> автоопределение timezone -> кнопки управления),
...
- `/start` — запросить геолокацию, автоматически определить таймзону и показать кнопки управления
